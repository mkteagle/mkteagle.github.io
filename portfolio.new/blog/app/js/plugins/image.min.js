...
!function (a) {
    ...
    a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
        ...
        function c() {
            ...
            c.val(""), ha && c.val(ha.attr("src")), c.trigger("change")
        }

        function d() {
            var a = b.$tb.find('.fr-command[data-cmd="insertImage"]'), c = b.popups.get("image.insert");
            if (c || (c = E()), r(), !c.hasClass("fr-active"))if (b.popups.refresh("image.insert"), b.popups.setContainer("image.insert", b.$tb), a.is(":visible")) {
        ...
        function e() {
            ...
            var d = ha.offset().left + ha.outerWidth() / 2, e = ha.offset().top + ha.outerHeight();
            b.popups.show("image.edit", d, e, ha.outerHeight())
        }
        ...
        function i() {
            ...
            if (ta)for (c = 0; c < ta.length; c++)e.indexOf(ta[c].getAttribute("src")) < 0 && b.events.trigger("image.removed", [a(ta[c])]);
            ta = d
        }
        ...
        function j() {
            ...
            b.$wp && (c -= b.helpers.getPX(b.$wp.css("border-left-width"))), ia.css("top", b.opts.iframe ? ha.offset().top - 1 : ha.offset().top + a).css("left", b.opts.iframe ? ha.offset().left - 1 : ha.offset().left + c).css("width", ha.outerWidth()).css("height", ha.outerHeight()).addClass("fr-active")
        }
        ...
        function l(c) {
            c.preventDefault(), c.stopPropagation(), ja = a(this), ja.data("start-x", c.pageX || c.originalEvent.touches[0].pageX), ka.show(), b.popups.hideAll()
        }
        ...
        function m(c) {
            if (ja) {
                ...
                if (!d)return !1;
                var e = ja.data("start-x");
                ja.data("start-x", d);
                var f = d - e, g = ha.width();
                if ((ja.hasClass("fr-hnw") || ja.hasClass("fr-hsw")) && (f = 0 - f), b.opts.imageResizeWithPercent) {
                    var h = ha.parentsUntil(b.$el, b.html.blockTagsQuery()).get(0);
                    ha.css("width", ((g + f) / a(h).outerWidth() * 100).toFixed(2) + "%")
                } else ha.css("width", g + f);
                ha.css("height", "").removeAttr("height"), j(), b.events.trigger("image.resize", [fa()])
            }
        }

        function n(a) {
            ja && (a && a.stopPropagation(), ja = null, ka.hide(), j(), e(), b.undo.saveStep(), b.events.trigger("image.resizeEnd", [fa()]))
        }

        function o(a, c) {
            b.edit.on(), t(b.language.translate("Something went wrong. Please try again.")), b.events.trigger("image.error", [{
                code: a,
                message: sa[a]
            }, c])
        }
        ...
        function p() {
            ...
            return b.$wp && (b.$wp.on("scroll.image-edit", function () {
                ha && b.popups.isVisible("image.edit") && e()
        ...
        function u() {
            var a = b.popups.get("image.insert"), c = a.find(".fr-image-by-url-layer input");
            c.val().length > 0 && (q(), s("Loading image"), v(b.helpers.sanitizeURL(c.val()), !0, [], ha), c.val(""), c.blur())
        }
        ...
        function v(c, d, e, f, g) {
            ...
            h.onload = function () {
                var d, h;
                if (f) {
                    d = f.clone(), f.replaceWith(d), d.off("load");
                    for (var i = d.get(0).attributes, j = 0; j < i.length; j++) {
                        var k = i[j];
                        0 === k.nodeName.indexOf("data-") && d.removeAttr(k.nodeName)
                    }
                    if ("undefined" != typeof e)for (h in e)"link" != h && d.attr("data-" + h, e[h]);
                    d.on("load", function () {
                        b.popups.hide("image.insert"), d.trigger("click").trigger("touchend"), b.events.trigger("image.loaded", [d])
                    }), d.attr("src", c), b.edit.on(), b.undo.saveStep(), b.events.trigger("image.replaced", [d, g])
                } else {
                    var l = "";
                    if ("undefined" != typeof e)for (h in e)"link" != h && (l += " data-" + h + '="' + e[h] + '"');
                    var m = b.opts.imageDefaultWidth;
                    m && "auto" != m && ("" + m).indexOf("px") < 0 && ("" + m).indexOf("%") < 0 && (m += "px"), d = a('<img class="fr-di' + b.opts.imageDefaultDisplay[0] + ("center" != b.opts.imageDefaultAlign ? " fr-fi" + b.opts.imageDefaultAlign[0] : "") + '" src="' + c + '"' + l + (m ? ' style="width: ' + m + ';"' : "") + ">"), d.on("load", function () {
        ...
        function y(a) {
            ...
            try {
                if (b.opts.imageUploadToS3)if (201 == c) {
                    var g = x(e);
                    g && v(g, !1, [], a, d || e)
                } else o(oa, d || e); else if (c >= 200 && 300 > c) {
                    var h = w(f);
        ...
        function z() {
            o(oa, this.response || this.responseText || this.responseXML)
        }
        ...
        function B(a) {
            ...
            if ("undefined" != typeof a && a.length > 0) {
                var c = a[0];
                if (c.size > b.opts.imageMaxSize)return o(pa), !1;
                if (b.opts.imageAllowedTypes.indexOf(c.type.replace(/image\//g, "")) < 0)return o(qa), !1;
                var d;
                if (b.drag_support.formdata && (d = b.drag_support.formdata ? new FormData : null), d) {
                    ...
                    var g = b.core.getXHR(f, b.opts.imageUploadMethod), h = ha;
                    g.onload = function () {
                        y.call(g, h)
                    }, g.onerror = z, g.upload.onprogress = A, q(), b.edit.off(), g.send(d)
                }
            }
        }
        ...
        function C(b) {
            b.on("dragover dragenter", ".fr-image-upload-layer", function () {
                ...
                this.files && B(this.files), a(this).val(""), a(this).blur()
            })
        }
        ...
        function D() {
            ...
            var c = function (a) {
                ...
                return c ? "undefined" != typeof b.browser.msie || "undefined" != typeof b.browser.edge : void a.preventDefault()
            }, d = function (a) {
                a.preventDefault()
            };
            b.events.on("dragenter", d, !0), b.events.on("dragover", c, !0), b.events.on("drop", function (c) {
                for (var d, e, f = 0; f < a.FroalaEditor.INSTANCES.length; f++)if (d = a.FroalaEditor.INSTANCES[f].$el.find("img.fr-img-move").get(0)) {
                    e = a.FroalaEditor.INSTANCES[f];
                    break
                }
                if (d) {
                    c.preventDefault(), c.stopPropagation(), X(!0), e != b && e.image && (e.image.exitEdit(!0), e.popups.hide("image.edit"));
                    var g, h;
                    "A" == d.parentNode.tagName && 0 === d.parentNode.textContent.length ? (h = a(d.parentNode), g = a(d.parentNode).clone(), g.find("img").removeClass("fr-img-move").on("load", W)) : (h = a(d), g = a(d).clone(), g.removeClass("fr-img-move").on("load", W)), b.markers.insertAtPoint(c.originalEvent);
                    var i = b.$el.find(".fr-marker");
                    return i.replaceWith(g), h.remove(), b.undo.saveStep(), !1
                }
                X(!0), b.popups.hideAll();
                ...
                if (j && j.files && j.files.length && (d = j.files[0], d && d.type && b.opts.imageAllowedTypes.indexOf(d.type.replace(/image\//g, "")) >= 0)) {
                    ...
                    return k || (k = E()), b.popups.setContainer("image.insert", a(b.opts.scrollableContainer)), b.popups.show("image.insert", c.originalEvent.pageX, c.originalEvent.pageY), q(), B(j.files), c.preventDefault(), c.stopPropagation(), !1
                }
            ...
            }), b.events.on("mousedown", Y), b.events.on("window.mousedown", Y), b.events.on("window.touchmove", Z), b.events.on("mouseup", X), b.events.on("window.mouseup", X), b.events.on("commands.mousedown", function (a) {
                a.parents(".fr-toolbar").length > 0 && X()
        ...
        function E() {
            ...
            return b.popups.onRefresh("image.insert", c), b.popups.onHide("image.insert", f), b.$wp && b.$wp.on("scroll.image-insert", function () {
                ha && b.popups.isVisible("image.insert") && da()
            }), b.events.on("destroy", function () {
        ...
        function F() {
            if (ha) {
                ...
                a.find("input").val(ha.attr("alt") || "").trigger("change")
            }
        }

        function G() {
            var c = b.popups.get("image.alt");
            c || (c = H()), r(), b.popups.refresh("image.alt"), b.popups.setContainer("image.alt", a(b.opts.scrollableContainer));
            var d = ha.offset().left + ha.width() / 2, e = ha.offset().top + ha.height();
            b.popups.show("image.alt", d, e, ha.outerHeight())
        }
        ...
        function H() {
            ...
            return b.popups.onRefresh("image.alt", F), b.$wp && (b.$wp.on("scroll.image-alt", function () {
                ha && b.popups.isVisible("image.alt") && G()
            }), b.events.on("destroy", function () {
        ...
        function I(a) {
            if (ha) {
                var c = b.popups.get("image.alt");
                ha.attr("alt", a || c.find("input").val() || ""), c.find("input").blur(), setTimeout(function () {
                    ha.trigger("click").trigger("touchend")
        ...
        function J() {
            if (ha) {
                ...
                a.find('input[name="width"]').val(ha.get(0).style.width).trigger("change"), a.find('input[name="height"]').val(ha.get(0).style.height).trigger("change")
            }
        }

        function K() {
            var c = b.popups.get("image.size");
            c || (c = L()), r(), b.popups.refresh("image.size"), b.popups.setContainer("image.size", a(b.opts.scrollableContainer));
            var d = ha.offset().left + ha.width() / 2, e = ha.offset().top + ha.height();
            b.popups.show("image.size", d, e, ha.outerHeight())
        }
        ...
        function L() {
            ...
            return b.popups.onRefresh("image.size", J), b.$wp && (b.$wp.on("scroll.image-size", function () {
                ha && b.popups.isVisible("image.size") && K()
            }), b.events.on("destroy", function () {
        ...
        function M(a, c) {
            if (ha) {
                ...
                ha.css("width", a || d.find('input[name="width"]').val()), ha.css("height", c || d.find('input[name="height"]').val()), d.find("input").blur(), setTimeout(function () {
                    ha.trigger("click").trigger("touchend")
                }, b.helpers.isAndroid() ? 50 : 0)
            }
        }
        ...
        function N(a) {
            ...
            if (ha || b.opts.toolbarInline)ha && (d = ha.offset().top + ha.outerHeight()); else {
            ...
            !ha && b.opts.toolbarInline && (d = e.offset().top - b.helpers.getPX(e.css("margin-top")), e.hasClass("fr-above") && (d += e.outerHeight())), e.find(".fr-layer").removeClass("fr-active"), e.find(".fr-" + a + "-layer").addClass("fr-active"), b.popups.show("image.insert", c, d, ha ? ha.outerHeight() : 0)
        }
        ...
        function Q() {
            if (ia = a('<div class="fr-image-resizer"></div>'), (b.$wp || a(b.opts.scrollableContainer)).append(ia), ia.on("mousedown", function (a) {
                    a.stopPropagation()
                }), a(b.original_window).on("resize.image" + b.id, function () {
                    b.helpers.isMobile() || X(!0)
                }), b.events.on("destroy", function () {
                    ia.html("").removeData().remove(), a(b.original_window).off("resize.image" + b.id)
                }, !0), b.opts.imageResize) {
                ia.append(k("nw") + k("ne") + k("sw") + k("se"));
                var c = ia.get(0).ownerDocument;
                ia.on(b._mousedown + ".imgresize" + b.id, ".fr-handler", l), a(c).on(b._mousemove + ".imgresize" + b.id, m), a(c.defaultView || c.parentWindow).on(b._mouseup + ".imgresize" + b.id, n), ka = a('<div class="fr-image-overlay"></div>'), a(c).find("body").append(ka), ka.on("mouseleave", n), b.events.on("destroy", function () {
                    ia.off(b._mousedown + ".imgresize" + b.id), a(c).off(b._mousemove + ".imgresize" + b.id), a(c.defaultView || c.parentWindow).off(b._mouseup + ".imgresize" + b.id), ka.off("mouseleave").remove()
                }, !0)
            }
        }

        function R(c) {
            c = c || ha, c && b.events.trigger("image.beforeRemove", [c]) !== !1 && (b.popups.hideAll(), X(!0), c.get(0) == b.$el.get(0) ? c.removeAttr("src") : ("A" == c.get(0).parentNode.tagName ? (b.selection.setBefore(c.get(0).parentNode) || b.selection.setAfter(c.get(0).parentNode), a(c.get(0).parentNode).remove()) : (b.selection.setBefore(c.get(0)) || b.selection.setAfter(c.get(0)), c.remove()), b.selection.restore(), b.html.fillEmptyBlocks(!0)), b.undo.saveStep())
        }

        function S() {
            D(), b.$el.on(b.helpers.isMobile() && !b.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == b.$el.get(0).tagName ? null : "img", W), b.helpers.isMobile() && (b.$el.on("touchstart", "IMG" == b.$el.get(0).tagName ? null : "img", function () {
                ua = !1
            }), b.$el.on("touchmove", function () {
                ua = !0
            })), b.events.on("keydown", function (c) {
                var d = c.which;
                return !ha || d != a.FroalaEditor.KEYCODE.BACKSPACE && d != a.FroalaEditor.KEYCODE.DELETE ? ha && d == a.FroalaEditor.KEYCODE.ESC ? (X(!0), c.preventDefault(), !1) : ha && !b.keys.ctrlKey(c) ? (c.preventDefault(), !1) : void 0 : (c.preventDefault(), R(), !1)
            }, !0), b.events.on("paste.before", U), b.events.on("paste.beforeCleanup", V), b.events.on("paste.after", T), b.events.on("html.set", h), h(), b.opts.iframe && b.events.on("image.loaded", b.size.syncIframe), b.$wp && (i(), b.events.on("contentChanged", i)), a(b.original_window).on("orientationchange.image." + b.id, function () {
                setTimeout(function () {
                    var a = fa();
                    a && a.trigger("click").trigger("touchend")
                }, 0)
            }), b.events.on("destroy", function () {
                b.$el.off("click touchstart touchend touchmove", "img"), b.$el.off("load", "img.fr-img-dirty"), b.$el.off("error", "img.fr-img-dirty"), a(b.original_window).off("orientationchange.image." + b.id)
            }, !0), b.events.on("node.remove", function (a) {
                return "IMG" == a.get(0).tagName ? (R(a), !1) : void 0
            })
        }
        ...
        function T() {
            b.opts.imagePaste ? b.$el.find("img[data-fr-image-pasted]").each(function (c, d) {
                if (0 === d.src.indexOf("data:")) {
                    ...
                    "auto" != f && (f += b.opts.imageResizeWithPercent ? "%" : "px"), a(d).css("width", f), a(d).addClass("fr-dib"), ha = a(d), j(), e(), da(), q(), b.edit.off();
                    ...
                    B([k]), a(d).removeAttr("data-fr-image-pasted")
        ...
        function W(c) {
            if (c && "touchend" == c.type && ua)return !0;
            if (b.edit.isDisabled())return c.stopPropagation(), c.preventDefault(), !1;
            b.toolbar.disable(), c.stopPropagation(), c.preventDefault(), b.helpers.isMobile() && (b.events.disableBlur(), b.$el.blur(), b.events.enableBlur()), b.opts.iframe && b.size.syncIframe(), ha = a(this), j(), e(), b.selection.clear(), b.button.bulkRefresh(), b.events.trigger("video.hideResizer");
        ...
        function X(a) {
            a === !0 && (va = !0), ha && va && (b.toolbar.enable(), ia.removeClass("fr-active"), b.popups.hide("image.edit"), ha = null), va = !1
        }
        ...
        function $(a) {
            ha.removeClass("fr-fir fr-fil"), "left" == a ? ha.addClass("fr-fil") : "right" == a && ha.addClass("fr-fir"), j(), e()
        }

        function _(a) {
            ha && (ha.hasClass("fr-fil") ? a.find("> i").attr("class", "fa fa-align-left") : ha.hasClass("fr-fir") ? a.find("> i").attr("class", "fa fa-align-right") : a.find("> i").attr("class", "fa fa-align-justify"))
        }

        function aa(a, b) {
            if (ha) {
                var c = "justify";
                ha.hasClass("fr-fil") ? c = "left" : ha.hasClass("fr-fir") && (c = "right"), b.find('.fr-command[data-param1="' + c + '"]').addClass("fr-active")
            }
        }

        function ba(a) {
            ha.removeClass("fr-dii fr-dib"), "inline" == a ? ha.addClass("fr-dii") : "block" == a && ha.addClass("fr-dib"), j(), e()
        }

        function ca(a, b) {
            var c = "block";
            ha.hasClass("fr-dii") && (c = "inline"), b.find('.fr-command[data-param1="' + c + '"]').addClass("fr-active")
        }

        function da() {
            var c = b.popups.get("image.insert");
            c || (c = E()), b.popups.isVisible("image.insert") || (r(), b.popups.refresh("image.insert"), b.popups.setContainer("image.insert", a(b.opts.scrollableContainer)));
            var d = ha.offset().left + ha.width() / 2, e = ha.offset().top + ha.height();
            b.popups.show("image.insert", d, e, ha.outerHeight())
        }

        function ea() {
            ha ? ha.trigger("click").trigger("touchend") : (b.popups.hide("image.insert"), b.toolbar.showInline())
        }
        ...
        function ga(a) {
            ...
            if (!b.opts.imageMultipleStyles) {
                ...
                c.splice(c.indexOf(a), 1), ha.removeClass(c.join(" "))
            }
            ha.toggleClass(a), ha.trigger("click").trigger("touchend")
        }

        var ha, ia, ja, ka, la = 1, ma = 2, na = 3, oa = 4, pa = 5, qa = 6, ra = 7, sa = {};
        sa[la] = "Image cannot be loaded from the passed link.", sa[ma] = "No link in upload response.", sa[na] = "Error during file upload.", sa[oa] = "Parsing response failed.", sa[pa] = "File is too large.", sa[qa] = "Image file type is invalid.", sa[ra] = "Files can be uploaded only to same domain in IE 8 and IE 9.";
        var ta, ua, va = !1;
        return {
            _init: S,
            showInsertPopup: d,
            showLayer: N,
            refreshUploadButton: O,
            refreshByURLButton: P,
            upload: B,
            insertByURL: u,
            align: $,
            refreshAlign: _,
            refreshAlignOnShow: aa,
            display: ba,
            refreshDisplayOnShow: ca,
            replace: da,
            back: ea,
            get: fa,
            insert: v,
